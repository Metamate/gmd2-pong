...
public class Game1 : Game
{
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        _spriteBatch.Draw(_texture, new Rectangle(5, 30, 5, 20), Color.White);
        _spriteBatch.Draw(_texture, new Rectangle(VIRTUAL_WIDTH - 10, VIRTUAL_HEIGHT - 50, 5, 20), Color.White);
        _spriteBatch.Draw(_texture, new Rectangle(VIRTUAL_WIDTH / 2 - 2, VIRTUAL_HEIGHT / 2 - 2, 4, 4), Color.White);
        _spriteBatch.End();
